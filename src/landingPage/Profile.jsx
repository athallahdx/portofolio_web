...
export default function Profile() {
  return (
    ...
    >
      ...
      ">
        <p className="text-xl xs:text-2xl sm:text-3xl mdp:text-4xl xl:text-3xl 2xl:text-5xl pb-1 md:pb-3">
          Hello, It&apos;s Me
        </p>
        <p className="text-2xl xs:text-3xl sm:text-4xl mdp:text-6xl 2xl:text-7xl">
      ...
      <div className="
        ...
        mt-[50px] xs:mt-6 sm:mt-[0px] mb-0 xs:mb-0 md:mb-0 mdp:mt-0 
        max-w-xs sm:max-w-lg mdp:max-w-xl lg:max-w-xl xl:max-w-2xl
      ">
        <img
          className="
            object-contain drop-shadow-2xl h-auto lg:w-auto 
            max-w-[45vw] xs:max-w-[60vw] sm:max-w-[40vw] mdp:max-w-[50vw] 
