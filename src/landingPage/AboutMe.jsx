            ...
            <div className="About-Me lg:max-w-screen mt-6 lg:mt-8 pb-8">
                <div className="flex text-left flex-col justify-center text-white items-center lg:max-w-[100vw]">
                    ...
                    >
                        ...
                        <p className="max-w-[93vw] text-sm xs:text-base mdp:text-xl 2xl:text-2xl  text-center mt-4">
                    ...
                    <div 
                        id="slide-right"
                        className={`dataanalystw-fit flex flex-col-reverse lg:flex-row justify-center items-center lg:items-start w-fit rounded-xl mt-5 sm:pb-5 xl:pb-0 2xl:pb-0 h-auto shadow-all-sides-lg border border-gray-800 max-w-[90vw] transition-transform duration-700 ease-out ${
                    ...
                    >
                        ...
                        <div className="picture1 w-full justify-items-center sm:pt-3 lg:pt-0 lg:w-auto lg:max-w-lg">
                            <img src={dev1} className="w-[25rem] h-auto rounded-t-xl sm:mt-3 lg:mt-0 sm:rounded-2xl sm:object-cover object-center lg:rounded-none lg:h-full lg:w-auto" alt="" />
                        </div>
                    </div>
                </div>
            </div>
