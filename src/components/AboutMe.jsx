                ...
                <div className="flex text-left flex-col justify-center text-white items-center lg:max-w-[100vw]">
                    ...
                    >
                        <div className="border-container text-center border-b-2">
                            <p className="text-3xl lg:text-6xl font-bold pb-1"><span>About</span> <span className="text-amber-500">Me</span></p>
                        </div>
                        <p className="max-w-[93vw] lg:text-xl 2xl:text-2xl  text-center mt-4">
                    ...
                    <div className="logos flex space-x-8 lg:space-x-36 mt-5 mb-8 justify-center">
                        <TechStackLogos isMobile={isMobile}/> 
                    </div>

                    {/* Data Analyst Section - Slide from Right */}
                    <div 
                        id="slide-right"
                        className={`dataanalystw-fit rounded-xl md:mt-5 flex flex-col items-center lg:flex-row h-auto justify-center shadow-2xl border border-gray-800 max-w-[90vw] transition-transform duration-700 ease-out ${
                    ...
                    >
                        <div className="picture1 w-full lg:w-auto lg:max-w-lg">
                            <img src={data1} className="h-[25vh] w-full rounded-t-xl lg:rounded-none lg:h-full lg:w-auto" alt="" />
                        </div>
                        <div className="desc1 ms-5 pb-5 md:pb-0 pe-4 lg:pe-12">
                            <p className="text-lg md:text-xl py-2 text-center lg:text-left font-semibold lg:mb-2">Data Analysis Expertise</p>

                            <ul className="list-disc list-outside text-base md:text-lg space-y-1 pl-5">
                    ...
                    <div 
                        id="slide-left"
                        className={`webdev w-fit rounded-xl mt-5 flex flex-col-reverse items-center lg:flex-row h-auto justify-center shadow-2xl border border-gray-800 max-w-[90vw] transition-transform duration-700 ease-out ${
                            isWebDevVisible ? 'lg:translate-x-0 lg:opacity-100' : 'lg:-translate-x-[100vw] lg:opacity-0'
                        }`}
                    >
                        <div className="desc1 ms-5 pb-5 md:pb-0 pe-4 lg:pe-12">
                            <p className="text-lg md:text-xl text-center lg:text-left font-semibold mt-3 mb-2">Web Development Skills</p>
                        ...
                        <div className="picture1 w-full lg:w-auto lg:max-w-lg">
                            <img src={dev1} className="h-[25vh] w-full rounded-t-xl lg:rounded-none lg:h-full lg:w-auto" alt="" />
                        </div>
                    </div>
                </div>
            </div>
