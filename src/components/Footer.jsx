...
export default function Footer() {
    return (
        <footer className="bg-footer-color text-white py-4 px-6 md:px-10 flex flex-col space-y-3 md:space-y-0 md:flex-row justify-between items-center text-base md:text-lg font-medium">
