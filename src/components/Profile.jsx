...
export default function Profile() {
  ...
  >
    <div className="Text-Description text-center lg:text-left lg:mt-20 2xl:mt-28 text-white font-bold flex flex-col justify-center">
      ...
      <p className="text-2xl lg:text-4xl pt-1 md:pt-3">
        And I&apos;m a{' '}
        <TypeAnimation
    ...
    <div className="Image-Profil animate-bounceCustom mb-8 md:mb-0 flex justify-center items-center max-w-xs sm:max-w-lg lg:max-w-xl xl:max-w-2xl">
      <img
        className="drop-shadow-2xl max-w-[60vw] lg:max-h-[600px] 2xl:max-h-full w-auto h-auto object-contain"
        src={profil}
        alt="Profile"
      />
    </div>
